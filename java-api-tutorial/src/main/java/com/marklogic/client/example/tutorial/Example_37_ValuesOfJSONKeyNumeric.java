...
/**
 * ValuesOfJSONKeyNumeric shows how to retrieve values from a numeric JSON key range index.
 */
public class Example_37_ValuesOfJSONKeyNumeric {

	public static void main(String[] args) throws IOException {
		System.out.println("example: "+Example_37_ValuesOfJSONKeyNumeric.class.getName());
		...
		String optionsName = Example_37_ValuesOfJSONKeyNumeric.class.getSimpleName();
