...
/**
 * ConstraintOnJSONValue shows how to define and use a JSON key/value constraint.
 */
public class Example_26_ConstraintOnJSONValue {

	public static void main(String[] args) throws IOException {
		System.out.println("example: "+Example_26_ConstraintOnJSONValue.class.getName());
		...
		if (tutorialOpts.getConstraint("company") == null)
