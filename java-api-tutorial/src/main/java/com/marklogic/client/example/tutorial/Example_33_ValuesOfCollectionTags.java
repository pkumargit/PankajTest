...
/**
 * ValuesOfCollectionTags shows how to retrieve values from the collection lexicon.
 */
public class Example_33_ValuesOfCollectionTags {

	public static void main(String[] args) throws IOException {
		System.out.println("example: "+Example_33_ValuesOfCollectionTags.class.getName());
		...
		String optionsName = Example_33_ValuesOfCollectionTags.class.getSimpleName();
