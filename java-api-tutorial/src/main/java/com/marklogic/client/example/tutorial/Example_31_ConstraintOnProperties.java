...
/**
 * ConstraintOnProperties shows how to define and use a properties search constraint.
 */
public class Example_31_ConstraintOnProperties {

	public static void main(String[] args) throws IOException {
		System.out.println("example: "+Example_31_ConstraintOnProperties.class.getName());
		...
		if (tutorialOpts.getConstraint("image") == null)
