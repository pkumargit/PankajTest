...
/**
 * SearchDirectory illustrates searching within a directory.
 */
public class Example_19_SearchDirectory {

	public static void main(String[] args) throws IOException {
		System.out.println("example: "+Example_19_SearchDirectory.class.getName());
